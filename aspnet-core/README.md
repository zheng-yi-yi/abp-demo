...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3943235e-4026-4b13-97d9-6d9a7a151c5e
```

> `3943235e-4026-4b13-97d9-6d9a7a151c5e` is the password of the certificate, you can change it to any password you want.
